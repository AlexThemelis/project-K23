...
Polygon_2 incremental_alg_SUBDIVISIAL(Polygon_2 polygonChain,vector<Point_2> vect, int initialization, visible flag_visible){
    ...
    for (auto it = polygonChain.begin(); it != polygonChain.end(); ++it)
    { 
